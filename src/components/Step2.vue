      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4" v-for="(plan, index) in plans" :key="index">
            <!--PRICE CONTENT START-->
            <div class="generic_content clearfix" :class="{ active: plan.isActive }">
              ...
              <div class="generic_head_price clearfix">
                ...
                <div class="generic_price_tag clearfix">
                  <span class="price">
                    ...
                    <span class="cent">.{{ plan.cent }}</span>
                    <span class="month">/{{ plan.period }}</span>
                  </span>
                </div>
                <!--//PRICE END-->
              </div>
              ...
              <div class="generic_price_btn clearfix">
                <a class="" href="">{{ plan.buttonText }}</a>
              </div>
              <!--//BUTTON END-->
            </div>
            <!--//PRICE CONTENT END-->
      ...
      plans: [
        {
          ...
          period: 'MON',
          features: [
            { name: 'Bandwidth', value: '2GB' },
            { name: 'Storage', value: '150GB' },
            { name: 'Accounts', value: '12' },
            { name: 'Host Domain', value: '7' },
        ...
        },
        {
          ...
          period: 'MON',
          features: [
            { name: 'Bandwidth', value: '5GB' },
            { name: 'Storage', value: '500GB' },
            { name: 'Accounts', value: '20' },
            { name: 'Host Domain', value: '15' },
            { name: 'Support', value: '24/7' }
          ],
          buttonText: 'Sign up',
          isActive: true
        },
        {
          ...
          features: [
            ...
            { name: 'Accounts', value: 'Unlimited' },
            { name: 'Host Domain', value: 'Unlimited' },
            { name: 'Support', value: '24/7' }
          ],
          buttonText: 'Sign up',
          isActive: false
