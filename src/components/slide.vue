<template>
        ...
        <div class="tarifBox text-center slick-slide slick-active" data-slick-index="1" aria-hidden="false" style="width: 394px;" tabindex="-1">
            ...
            <div class="dateEffet mb-2 mt-2" data-bs-toggle="modal" data-bs-target="#dateEffet">A partir du : <span class="effetDate mx-2">{{ formatDate(dateEffet) }}</span> 
            ...
            <div class="composants">
                <ul> 
                    ...
                    <li :class="[['ECO', 'CONFORT'].includes(props.tarif.formule) ? 'uncheck' : '']">Dommages électriques <strong></strong></li> 
                    ...
                    <li :class="[['ECO'].includes(props.tarif.formule) ? 'uncheck' : '']">3 mois d’assurance OFFERTS* <strong></strong></li>
                </ul>
            </div>
            <div class="tarifActions">
                <a href="#" @click="defineTarifSelected(tarif)"  tabindex="0"><button class="standardBtn" tabindex="0">Souscrire en ligne</button></a>
            </div>
        </div>                
