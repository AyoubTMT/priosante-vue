...
export const useFormStore = defineStore('form', {
  ...
  getters: {
    ...
    getDataForSave: (state) => ({
      ...
      typeHabitation: 'MAISON_INDIVIDUELLE',
      typeResidence: 'RESIDENCE_PRINCIPALE',
      qualiteAssure: 'LOCATAIRE_OCCUPANT',
      codePostal: '75001',
      ville: 'paris',
      nbrPiecePrincipale: '4',
      ...
      capitalMobilier: '16000',
      formuleChoisi: 'CONFORT',
      franchise: 'TROISCENTS',
      indemnisationMobilier: '10',
      niveauGarantieObjVal: '',
      declarAssistantMatern: '',
      panneauPhotoVolt: 'NON',
      bienElectrMoin5ans: 'NON',
      modePaiement: 'CHEQUE',
      souscripteurAdressePostale: 'complement',
      souscripteurVille: 'paris',
      souscripteurCodePostal: '75001',
      souscripteurNom: 'test nom',
      souscripteurCV: 'MR',
      souscripteurTel: '0613131313',
      souscripteurPrenom: 'test prenom',
      souscripteurEmail: 'test@gmail.com',
